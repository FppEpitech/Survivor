export const messages = {
    ...
    keysFound: (keysCount, filesCount) => `${keysCount} keys were found in ${filesCount} ${filesCount > 1 ? 'files' : 'file'}.`,
    ...
    problematicKeysForUnflat: (keys) => `The following keys won't be accessible when unflatting the object:\n ${keys
        .map((k) => `"${k}"`)
        .join(', ')}`,
};
